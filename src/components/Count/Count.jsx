  ...
  return (
    <div className="w-11/12 mx-auto my-10">
      <div className="flex py-8 gap-3 justify-center items-center">
        <div className="bg-[#8e67f1] w-20 h-1"></div>
        <h3 className="text-center font-bold text-3xl">Learning Journey Highlights</h3>
        <div className="bg-[#8e67f1] w-20 h-1"></div>
      </div>
        ...
        <div className="">
          ...
          >
            <div className="grid md:grid-cols-2 py-20 gap-8 justify-between">
              {/* Counter 1 */}
              <div className="text-center border p-3 text-[#5e3598]">
                <div className=" text-6xl font-bold w-full">
                  {counterOn && <CountUp end={58.6} />}K
                </div>
                <h2 className="text-center py-3 font-bold text-xl text-[#0b0505]">
                  Student enrolled
                </h2>
                <p className="text-center text-[#0b0505]">
